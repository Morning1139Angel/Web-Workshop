...
> ***Pro:*** اها!‌ <u>streaming platform یک software ای هست که میتواند نیازهایی که در موقع پیاده‌سازی stream processing  بهشان برمی‌خوریم را مهیا بکند.</u>
> ***Noob:***  خیلی عالی... فقط stream processing اون‌وقت چیه؟ و چالش هایی که تو پیاده کردنش داریم چیان ؟ و کافکا دقیقا چطوری این مشکلات رو حل میکنه؟
> ***Pro:***  اینا همه سوال‌های خیلی خوبین...

 بیاین برای درک کردن بهتر از هدف کافکا، اینکه کافکا به درد چه کارهایی میخوره و اینکه چه مشکلاتی رو سعی میکنه برامون حل کنه، ابتدا اندکی راجب **stream  processing**  صحبت کنیم چرا که همون طور که از گفت‌وگوی بالا میبینید کافکا ابزاری برای stream processing میباشد.

---
##Stream Processing
####chalanges
---
##kafka: a tool for stream processing
####kafka structure
---
##code Implementation
---
##kafka's relation with other tool
####database
####messaging systems
---
##Summary
