...
> ***Pro:***  اینا همه سوال‌های خیلی خوبین...
 ...
 بیاین برای درک کردن بهتر از هدف کافکا، اینکه کافکا به درد چه کارهایی میخوره و اینکه چه مشکلاتی رو سعی میکنه برامون حل کنه، ابتدا اندکی راجب **stream  proccessing**  صحبت کنیم چرا که همون طور که از گفت‌وگوی بالا میبینی کافکا ابزاری برای stream processing میباشد.
